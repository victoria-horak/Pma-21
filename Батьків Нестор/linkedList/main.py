...
mylist.remove_entries(6, 3).toFile(result_file)
mylist.clear()
add_to_file(f"insert 1 at index:-2")
mylist.insert(0, 0).toFile(result_file)
add_to_file(f"insert {arr} at index: 0")
mylist.insert(0, *arr).toFile(result_file)
